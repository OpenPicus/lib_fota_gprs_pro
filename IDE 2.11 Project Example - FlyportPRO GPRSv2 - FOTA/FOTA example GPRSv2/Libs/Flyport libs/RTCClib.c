 ...
 * Function to configure the alarm. It's possible to set the interval for the alarm and if must be repeated continously.
  * \param rtcc - a struct tm containing the alarms date/time.
 ...
 * \param whenToRaise - how often alarm should be raised
 <UL>
 ...
 * \param fptr custom user function to execute when alarm event is raised. <B>please use NO_ALRM_EVENT</B> to ignore.
 * \return None
 */
