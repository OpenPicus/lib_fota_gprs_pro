...
extern int SaraStdModeOn(long int baud);
...
const long int baudComp[16] = {	1200,	2400,	4800,	9600,
...
void GSMTask()
{
    ...
    // SARA FTP ERROR callback
    FP_GSM[38] = cFTPGetError;
	...
	if (hFlyTask == NULL)
	{
		...
		// Enter Standard Mode:
		while(SaraStdModeOn(baudComp[7])); // 115200 baud...
	}
