...
// GSM Module struct
#define OPERATOR_NAME_LEN	25
#define IMEI_LEN			18
#define MODEL_VER_LEN		20
#define MODEM_FW_REV_LEN	20
typedef struct 
{
    ...
    char    OperatorName[OPERATOR_NAME_LEN+1];
    char    ModelVersion[MODEL_VER_LEN+1];
    char    FwRevision[MODEM_FW_REV_LEN+1];
}GSMModule;
