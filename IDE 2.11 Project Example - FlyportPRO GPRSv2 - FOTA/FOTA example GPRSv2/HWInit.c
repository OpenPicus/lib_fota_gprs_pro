...
extern void SaraPowerOnMosfet(BOOL);
/****************************************************************************
...
// Set all pins as input by default
        ...
        SARA_RESET_ODC      = 1;
        SARA_RESET_TRIS     = 0;
        SARA_RESET_IO       = 1;  // REMOVE RESET SIGNAL!
        
        // SARA-ON Mosfet pin
        SARA_ON_TRIS        = 0; // Set mosfet pin as output!
        SaraPowerOnMosfet(FALSE); // Turn off SARA power supply!
